...
class ServicePartForm(forms.ModelForm):
    class Meta:
        model = ServicePart
        fields = ['name', 'part_number', 'stock', 'minimum_stock', 'unit', 'cost_price', 'sale_price', 'shelf', 'notes']
        widgets = {
            ...
            'cost_price': forms.NumberInput(attrs={'class': 'form-control', 'min': 0, 'step': '0.01', 'placeholder': 'Ex: 45.00'}),
            'sale_price': forms.NumberInput(attrs={'class': 'form-control', 'min': 0, 'step': '0.01', 'placeholder': 'Ex: 75.00'}),
