    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='expiry_profile', to='accounts.car', verbose_name='Mașină')),
            ],
            options={
